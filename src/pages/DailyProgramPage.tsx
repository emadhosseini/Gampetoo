...
export default function DailyProgramPage() {
  ...
  return (
    <div>
      ...
      {/* "تقویم هفته" used to sit in its own row here — it's now part of
          WorkoutHeader's own action row inside WorkoutPage, sharing one
          line with the forgot/edit buttons. */}
